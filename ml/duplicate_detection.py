...
Does not declare fraud or assign arbitrary accusations.
"""
import math
import re
...
try:
    ...
    DEFAULT_COST_SIMILARITY_RATIO_THRESHOLD = 0.95
...
class NearDuplicateDetector:
    """Pairwise near-duplicate and overlapping works detection for full risk pipeline."""
